...
fn main() {
    ...
    let material_ground = Rc::new(Lambertian::new(Color::new(0.5, 0.2, 0.1))); // brown matte
    let material_center = Rc::new(Lambertian::new(Color::new(0.2, 0.6, 0.4))); // turqoiuse matte
